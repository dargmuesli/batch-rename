...
Namespace My
    ...
    Partial Friend NotInheritable Class MySettings
        Private Sub MySettings_PropertyChanged(ByVal sender As Object, ByVal e As PropertyChangedEventArgs) Handles MyClass.PropertyChanged

            ' Automatically save new settings
            Settings.Save()
        End Sub
    End Class
End Namespace
